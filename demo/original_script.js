/* 
    TACTICAL RANGE CARD PRO - DEMO SIMULATOR v2.1
    SECURITY: SANDBOX MODE ACTIVE
*/
window.IS_TACTICAL_DEMO = true;
    ...
    if (cinemaBtn) {
        cinemaBtn.addEventListener('click', () => {
            if (!document.fullscreenElement) {
                ...
                cinemaBtn.innerHTML = '<i data-lucide="video-off" class="w-4 h-4 mr-2"></i> EXIT CINEMA MODE';
                document.body.style.overflow = 'hidden';
            } else {
                if (document.exitFullscreen) {
                    document.exitFullscreen();
                }
                cinemaBtn.innerHTML = '<i data-lucide="video" class="w-4 h-4 mr-2"></i> ENTER CINEMA MODE';
